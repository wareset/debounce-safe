...
//     let iam: any, args: any,
//       tID: ReturnType<typeof setTimeout> | null, res: any, run = true
  
//     function awaiter(): void {
//       tID = null
//       !leading || leading !== throttle ? exec(iam, args) : iam = args = tID /* null */
//     }
//     function clearID(): void { tID && (clearTimeout(tID), tID = null) }
//     function timeout(): void { tID = setTimeout(awaiter, wait) }
  
//     function exec(_iam: any, _args: any): any {
//       _args && run &&
//       (iam = args = null, run = false, res = func.apply(_iam, _args), run = true)
//       return res
//     }
